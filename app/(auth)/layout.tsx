      ...
      <div className="relative hidden lg:flex lg:w-[45%] flex-col items-center justify-center overflow-hidden bg-stone-200/60 p-10">
        <div className="flex flex-col items-center gap-8">
          ...
          >
            ...
            <text x={6} y={100} textAnchor="middle" fill="#78716C" fontSize={11} fontWeight={500} fontFamily="system-ui, sans-serif" transform="rotate(-90, 6, 100)">Intent →</text>
            {DOTS.map((d, i) => {

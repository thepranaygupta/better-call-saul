  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <div className="h-7 w-32 animate-pulse bg-stone-200" />
        <div className="h-4 w-64 animate-pulse bg-stone-200" />
      </div>

      {/* Tabs skeleton */}
      <div className="flex gap-4 border-b border-stone-200 pb-2">
        <div className="h-5 w-24 animate-pulse bg-stone-200" />
        <div className="h-5 w-20 animate-pulse bg-stone-200" />
      </div>

      {/* Table skeleton */}
      <div className="space-y-0 overflow-hidden border border-stone-200 bg-white">
        {/* Header */}
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            <div className="h-4 w-28 animate-pulse bg-stone-100" />
            <div className="h-4 w-20 animate-pulse bg-stone-100" />
            <div className="h-4 w-14 animate-pulse bg-stone-100" />
